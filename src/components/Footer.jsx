...
function Footer() {
  return (
    ...
    <div className='websites' style={{width:'400px'}}>
      ...
      <h6>
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi asperiores deserunt provident a dignissimos ab aut perspiciatis voluptates odit earum, tempore eius, quos sed distinctio magnam vitae rem sequi tempora.
      </h6>
    </div>
    ...
    <p className='mt-5'>Copyright © 2023 Media Player . Bulit with React</p>
