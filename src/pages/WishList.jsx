...
: <div style={{height:'100vh'}} className='d-flex flex-column justify-content-center align-items-center'>
  <img src="https://cdn.dribbble.com/users/5107895/screenshots/14532312/media/a7e6c2e9333d0989e3a54c95dd8321d7.gif" alt="np image" height={'300px'} />
  <h4 className='text-danger mt-3'>Your wishlist is empty</h4>
  <Button  className='btn btn-success rounded mt-3'><Link style={{textDecoration:'none' , color:"white"}} to={'/'}> <i class="fa-solid fa-angles-left me-3"></i> Back to home</Link></Button>
</div>
}
